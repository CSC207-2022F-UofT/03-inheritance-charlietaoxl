...
public class CrossbodyBag extends Bag{
     ...
     *
     * @param color a string denoting the color
     * @param capacity an integer denoting the size
     * @param numberOfStraps an integer denoting the number of straps
     */
    ...
    /**
     * Increases the capacity of CrossbodyBag by 2
     */
    @Override
    public void enhance() {
